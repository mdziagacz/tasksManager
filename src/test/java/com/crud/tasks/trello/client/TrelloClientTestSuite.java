...
public class TrelloClientTestSuite {
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        trelloBoards[0] = new TrelloBoardDto("testBoard", "testId",new ArrayList<>());
    ...
    public void shouldCreateCard() throws URISyntaxException{
        ...
        URI uri = new URI("http://test.com/cards?key=test&token=test&name=Test%20task&desc=Test%20Description&pos=top&idList=testId");
